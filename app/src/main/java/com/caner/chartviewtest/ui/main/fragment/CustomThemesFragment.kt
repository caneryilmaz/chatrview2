...
import com.caner.chartviewtest.viewmodel.CustomThemesViewModel
...
class CustomThemesFragment : Fragment() {
  ...
  //  private lateinit var charts_view: ChartsView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //   charts_view = requireView().findViewById(R.id.charts_view)
        provideViewModel()
    ...
    private fun provideViewModel() {
        viewModel = ViewModelProvider(this)[CustomThemesViewModel::class.java]
    }
    ...
    private val darkThemeOptions: ChartOptions.() -> Unit = {
        layout = layoutOptions {
            backgroundColor = Color.parseColor("#ffffff").toIntColor()
    ...
    private fun createSeriesWithData(
        ...
        chartApi.addAreaSeries(
            options = AreaSeriesOptions(
                topColor = Color.argb(0, 0, 0, 0).toIntColor(),
                bottomColor = Color.argb(10, 33, 150, 243).toIntColor(),
                lineColor = Color.argb(255, 0, 0, 0).toIntColor(),
    ...
    private fun applyChartOptions() {
        applyThemeOptions(lightThemeOptions)
    }
